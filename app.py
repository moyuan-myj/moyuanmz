...
st.write("使用说明：")
st.write("1.面板和增伤都是可以代入公式计算的，如要算一个士兵的攻击面板，可以直接输入233*(1+0.2+0.3)。但注意一定要使用英文的括号和英文的* /乘除法。")
...
st.write("单点版将网址中的 jsq 替换为 ddjsq ，AOE版将网址中的 jsq 替换为 aoejsq ，梦战计算器使用交流群 928411216")
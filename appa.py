...
with st.expander("（点击打开查看）与AOE有关的士兵科技参考"):
    chakan_sbkj = pd.DataFrame( {"士兵种类": ["步兵","步兵","枪兵", "枪兵", "骑兵","飞兵","弓兵","刺客","法师","僧兵","僧兵","魔物"],
             "科技名称": ["对枪特训", "应急处理", "对骑特训", "作战续行","对步特训","特技飞行","密林游侠","以法特训","圣光护佑","对魔特训", "圣光护佑", "污秽铠甲"],
             "科技效果": ["对枪兵士兵攻防克制修正+30%", "士兵大于80%血，减伤20%","对骑兵士兵攻防克制修正+30%","士兵低于70%血时,减伤20%","对步兵士兵攻智防克制修正+30%","站地形时,减伤+20%","对飞兵士兵攻防克制修正+30%","与法师士兵/英雄或僧侣士兵/英雄交战时，双防克制修正+30%","部队满血时，减伤30%","对魔物士兵攻防克制修正+30%", "部队满血时，减伤30%","常驻双防+20%，但与魔物或僧侣交战时，双防克制修正-16%"]})

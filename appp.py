    ...
    chakan_sbkj = pd.DataFrame(
            {"士兵种类": ["步兵", "步兵", "步兵", "步兵", "步兵", "枪兵", "枪兵", "枪兵", "枪兵", "枪兵", "骑兵",
             ...
             "科技效果": ["对枪兵士兵攻防克制修正+30%", "敌人生命百分比<=自身时,攻防+20%", "士兵大于80%血，减伤20%",
                          ...
                          "进攻被护卫时,攻防+20%", "高于80%血时,攻防+20%", "主动攻击满血敌人时,攻防+20%",
                          "站地形时,减伤+20%", "部队是混合部队时,双防+20%", "高于80%血时,攻防+20%",
                          "主动攻击满血敌人时,攻防+20%", "在水中时,增伤+30%", "在水中被打,攻击+20%,魔防+20%",
                          "站地形时，攻防+20%", "主动攻击满血敌人时,攻防+20%", "站地形时，增伤+30%",
                          "对飞兵士兵攻防克制修正+30%", "被近战打，双防+20%", "站地形时，攻防+20%",
                          "主动攻击满血敌人时,攻防+20%", "主动攻击满血敌人时,增伤+30%", "与法师士兵/英雄或僧侣士兵/英雄交战时，双防克制修正+30%",
...
#计算兵打英雄物理伤害
    ...
    bdyx_ddbj_sh = bdyx_dd_sh * (1.3+gf_sb_bs-sf_yx_jbs)
else:
#计算兵打兵魔法伤害
...
st.markdown(f"<strong><span style='color:red;font-size:20px;'>以下即将进行段数分配战斗模拟</span></strong>", unsafe_allow_html=True)
...
<span style="color: orange;">一、单段伤害计算区，可以实际模拟出兵打兵、兵打人、人打兵、兵打人四个维度的单段伤害。</span>
...
<span style="color: orange;">二、段数分配模拟区</span>
...
<span style="color: orange;">四、缺陷</span>
